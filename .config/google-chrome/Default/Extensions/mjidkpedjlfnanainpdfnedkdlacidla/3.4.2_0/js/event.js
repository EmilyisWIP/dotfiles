...
chrome.extension.sendMessage({type: "config"}, function (response) {
    ...
    var cmg = {
        ...
        init: function () {
            window.addEventListener("mousescroll", this, true);
            ...
            if (cmg.valuedrag) {
                ...
                window.addEventListener("drag", this, true);
        ...
        handleEvent: function (e) {
            switch (e.type) {
                ...
                case "dragstart":
                    /*fixed svgdiv*/
                    if (document.getElementById("svgdivmjidkpedjlfnanainpdfnedkdlacidla")) {
                        document.getElementById("svgdivmjidkpedjlfnanainpdfnedkdlacidla").parentNode.removeChild(document.getElementById("svgdivmjidkpedjlfnanainpdfnedkdlacidla"));
                    }
        ...
        _progressGesture: function (e) {
            ...
            if (dx > 5 || dy > 5) {
                if (cmg.valuegestureui && (cmg.valuestroke || teststroke)) {
                    if (!document.getElementById("svgdivmjidkpedjlfnanainpdfnedkdlacidla")) {
                        ...
                        svgdiv.id = "svgdivmjidkpedjlfnanainpdfnedkdlacidla";
            ...
            if (direction != lastDirection) {
                ...
                if (!document.getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla") && (teststroke || (cmg.valuegestureui && (cmg.valuedirect || cmg.valuetooltip)))) {
                    var _infoshow = document.createElement("div");
                    _infoshow.id = "infoshowmjidkpedjlfnanainpdfnedkdlacidla";
                    ...
                    if (cmg.valuedirect || teststroke) {
                        ...
                        _dirshow.id = "dirshowmjidkpedjlfnanainpdfnedkdlacidla";
                        ...
                        document.getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla").appendChild(_dirshow);
                    }

                    if (cmg.valuetooltip || teststroke) {
                        var _tipshow = document.createElement("div");
                        _tipshow.id = "tipshowmjidkpedjlfnanainpdfnedkdlacidla";
                        ...
                        document.getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla").appendChild(_tipshow);
                    }
                }

                /**/
                if ((cmg.valuedirect || teststroke) && document.getElementById("dirshowmjidkpedjlfnanainpdfnedkdlacidla")) {
                    var _dirlength = this._directionChain.length;
                    document.getElementById("dirshowmjidkpedjlfnanainpdfnedkdlacidla").style.width = Math.min(32 * (_dirlength + 1), window.innerWidth) + "px";
                    document.getElementById("dirshowmjidkpedjlfnanainpdfnedkdlacidla").style.paddingTop = "3px";
                    if (cmg.fixPaddingBottom) {
                        document.getElementById("dirshowmjidkpedjlfnanainpdfnedkdlacidla").style.paddingBottom = "3px";
                    }
                    ...
                    document.getElementById("dirshowmjidkpedjlfnanainpdfnedkdlacidla").appendChild(_showimg);
                }
                /**/

                /***/
                if ((cmg.valuetooltip || teststroke) && document.getElementById("tipshowmjidkpedjlfnanainpdfnedkdlacidla")) {
                    ...
                    chrome.extension.sendMessage({type: "tipshow", direct: this._directionChain, tiptype: "gesture"}, function (response) {
                        if (response.moreDes != "none") {
                            document.getElementById("tipshowmjidkpedjlfnanainpdfnedkdlacidla").innerHTML = response.moreDes;
                        }
                        else {
                            document.getElementById("tipshowmjidkpedjlfnanainpdfnedkdlacidla").innerHTML = "";
                        }
                    })
                }
            }
            ...
            switch (e.target.nodeType) {
                ...
                case 1:
                    if (e.target.value && cmg.valuedragtext && cmg.valuedraginput) {
                        ...
                        if (1) { //fix selection & drag to search & open link strategy
...
//					}
        ...
        _dragprogress: function (e) {
            ...
            /*drag ui ready*/
            if (!document.getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla")
            ...
            if (direction != lastDirection) {
                ...
                /**/
                if ((cmg.valueddirect || teststroke) && document.getElementById("dirshowmjidkpedjlfnanainpdfnedkdlacidla")) {
                    var _dirlength = this._directionChain.length;
                    document.getElementById("dirshowmjidkpedjlfnanainpdfnedkdlacidla").style.width = Math.min(32 * (_dirlength + 1), window.innerWidth) + "px";
                    document.getElementById("dirshowmjidkpedjlfnanainpdfnedkdlacidla").style.paddingTop = "3px";
                    if (cmg.fixPaddingBottom) {
                ...
                /***/
                if ((cmg.valuedtooltip || teststroke) && document.getElementById("tipshowmjidkpedjlfnanainpdfnedkdlacidla")) {
                    var sendmsg = {};
                ...
                if ((cmg.valueddirect || cmg.valuedtooltip || teststroke) && document.getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla")) {
                    document.getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla").style.cssText += "z-index:100000 !important"
                }
            }
        ...
        _strokeclear: function () {
            ...
            if (document.getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla")) {
                document.getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla").parentNode.removeChild(document.getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla"))
            }
            return true;
        },
        _UiReady: function () {
    ...
    function (request, sender, sendResponse) {
        ...
        if (request.notifitype == "bookmark"
            ...
            window.setTimeout(function () {
                if (document.getElementById("notifiboxmjidkpedjlfnanainpdfnedkdlacidla")) {
                    document.getElementById("notifiboxmjidkpedjlfnanainpdfnedkdlacidla").parentNode.removeChild(document.getElementById("notifiboxmjidkpedjlfnanainpdfnedkdlacidla"))
                }
            }, 2000)
        }

        function addnotifibox() {
            var _obj = document.getElementById("notifiboxmjidkpedjlfnanainpdfnedkdlacidla");
            if (_obj) {
            ...
            notifidiv.id = "notifiboxmjidkpedjlfnanainpdfnedkdlacidla"
